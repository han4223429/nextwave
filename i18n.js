...
window.I18N = (function () {
    const dict = {
        ko: {
            ...
            'hero.stage1.kicker': '처음이어도 괜찮아',
            'hero.stage1.title': '전공은 달라도,<br>우리는 <span class="text-gradient">같이 만든다.</span>',
            'hero.stage1.body': '코드를 처음 만지는 사람도, 이미 만들고 있는 사람도 같은 테이블에서 시작해요.',
            'hero.stage2.kicker': '한 팀 안에 네 가지 엔진',
            'hero.stage2.title': '개발 · 게임개발<br>해커톤 · 마케팅',
            'hero.stage2.body': '기획하는 사람, 만드는 사람, 알리는 사람이 섞일 때 결과물이 빨라져요.',
            'hero.stage3.kicker': '아이디어가 움직이는 순간',
            'hero.stage3.title': '작게 만들고,<br>빠르게 보여주고, 같이 고친다.',
            'hero.stage3.body': '하루짜리 실험도 좋고, 대회용 프로토타입도 좋아요. 멈춰 있는 아이디어를 화면으로 꺼냅니다.',
            'hero.stage4.kicker': '수업 밖에서 남는 것',
            'hero.stage4.title': '서비스, 게임, 수상 경험까지<br>진짜 결과물로 남겨요.',
            'hero.stage4.body': '포트폴리오에 쓸 수 있는 장면을 만들고, 같이 만든 동료도 함께 남습니다.',
        ...
        en: {
            ...
            'hero.stage1.kicker': 'Beginners are welcome',
            'hero.stage1.title': 'Different majors,<br>we <span class="text-gradient">build together.</span>',
            'hero.stage1.body': 'People touching code for the first time and people already shipping things start at the same table.',
            'hero.stage2.kicker': 'Four engines in one team',
            'hero.stage2.title': 'Development · Game dev<br>Hackathons · Marketing',
            'hero.stage2.body': 'When planners, builders, and storytellers mix, ideas turn into results faster.',
            'hero.stage3.kicker': 'The moment an idea starts moving',
            'hero.stage3.title': 'Build small,<br>show it fast, improve it together.',
            'hero.stage3.body': 'A one-day experiment is enough. So is a contest prototype. We pull still ideas onto the screen.',
            'hero.stage4.kicker': 'What remains beyond class',
            'hero.stage4.title': 'Services, games, awards<br>that become real proof.',
            'hero.stage4.body': 'You leave with portfolio scenes, real attempts, and the people who built them with you.',
